...
import 'package:squareboat/components/location_chip.dart';
...
class LocationPickerWidget extends HookWidget {
  ...
  final Function(dynamic location, String formatted) onLocationAdded;
    ...
    void handleSuggestionTap(String placeId) async {
      try {
        ...
        if (response.statusCode == 200) {
          ...
          // log("result here for address: ${response.data} :: ${response.data['formatted_address']}");
          // log("result \n\n here for formatterd address: ${response.data['result']['geometry'].runtimeType}");
          ...
          if (description.isNotEmpty) {
            ...
            if (maxSelections != null &&
              ...
              onLocationAdded(
                  response.data?['result']?['geometry'] ?? {}, description);
